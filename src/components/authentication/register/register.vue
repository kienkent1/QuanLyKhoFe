...
import GoogleButton from "../btn-gg/BtnGoogle.vue";
import { ref } from "vue";
...
async function submitRegister() {
  ...
  if (!idNhanVien.value.trim()) errors.value.idNhanVien = "Vui lòng nhập ID";
    ...
    <div class="flex flex-1 items-center justify-center">
      ...
      >
        ...
        <p class="text-center text-gray-600 mb-6">
          Chào mừng đến với công ty Bấu De
        </p>
        ...
        <GoogleButton @success="handleGoogleToken">
          Đăng ký bằng Google
        </GoogleButton>
