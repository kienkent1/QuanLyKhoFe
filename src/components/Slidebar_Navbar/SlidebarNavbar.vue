<template>
  <div class="flex">
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
      ...
      <div class="h-full px-3 py-4 overflow-y-auto">
        <a href="/" class="flex items-center ps-2.5 mb-5">
          <img src="../../assets//logo.png" class="h-20" alt="dau Logo" />
    ...
    <div v-if="sidebarOpen && windowWidth <= 600" @click="toggleSidebar"
      class="fixed inset-0 bg-white bg-opacity-40 sm:hidden z-10"></div>
        ...
        <div v-if="windowWidth > 770">
          <div class="flex-grow flex justify-center mx-6">
            <div class="relative w-[400px] max-w-full">
              <input @keyup.enter="searchGoogle()" v-model="query" type="text" placeholder="Tìm kiếm..."
