<template>
  <div class="flex">
      ...
      <div class="h-full px-3 py-4 overflow-y-auto">
        ...
        <ul class="space-y-2 font-medium">
          ...
          <li>
            <routerLink
              to="/nha-cung-cap"
              :class="getActiveClasses('/nha-cung-cap')"
            >
          ...
          <li>
            <routerLink to="/loai" :class="getActiveClasses('/loai')">
              <span :class="getActiveIconClasses('/loai')"> category </span>
          ...
          <li>
            <router-link
              to="/nhan-vien"
              :class="getActiveClasses('/nhan-vien')"
            >
          ...
          <li>
            <router-link
              to="/tai-khoan"
              :class="getActiveClasses('/tai-khoan')"
            >
          ...
          <li>
            <a
              href="#"
              class="flex items-center p-2 text-[#7A8699] rounded-lg hover:bg-[#E5F2FF] group"
            >
              <span
                class="material-icons w-5 h-5 text-[#7A8699] group-hover:text-[#007AFF]"
                >bar_chart</span
              >
          ...
          <li>
            <router-link
              to="/xuat-Nhap"
              :class="getActiveClasses('/xuat-Nhap')"
            >
              <span :class="getActiveIconClasses('/xuat-Nhap')"
                >upload_file</span
              >
          ...
          <li>
            <router-link
              to="/phan-Quyen"
              :class="getActiveClasses('/phan-Quyen')"
            >
              <span :class="getActiveIconClasses('/phan-Quyen')"
    ...
    <div
      v-if="sidebarOpen && windowWidth <= 600"
      @click="toggleSidebar"
      class="fixed inset-0 bg-white bg-opacity-40 sm:hidden z-10"
    ></div>
    <div
      :class="sidebarOpen ? 'sm:ml-64 w-[calc(100%-16rem)]' : 'ml-0 w-full'"
