...
<template>
  <div class="p-6 bg-gray-50 space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div
        v-for="(card, i) in cardStats.slice(0, 2)"
        :key="i"
      ...
      <div
        class="col-span-1 sm:col-span-2 flex gap-0 overflow-hidden rounded-2xl shadow"
      >
        <!-- Thẻ xanh dương -->
        <div
          class="flex-1 flex items-center justify-between bg-blue-600 text-white p-5"
        >
          <div>
          ...
          <div class="relative w-12 h-12 flex items-center justify-center">
            <div
              class="absolute inset-0 border-4 border-white border-t-transparent rounded-full animate-spin-slow"
            ></div>
        ...
        <!-- Thẻ xanh lá -->
        <div
          class="flex-1 flex items-center justify-between bg-green-500 text-white p-5"
        >
          <div>
          ...
          <div class="relative w-12 h-12 flex items-center justify-center">
            <div
              class="absolute inset-0 border-4 border-gray-200 border-t-transparent rounded-full animate-spin-slow"
            ></div>
            <span class="text-xs font-semibold">+5%</span>
          </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <div class="bg-white p-6 rounded-2xl shadow-sm">
        ...
        <div class="flex justify-between items-center mb-8">
          <div>
            <button
              class="bg-blue-100 text-blue-600 px-3 py-1 rounded-lg text-sm font-medium"
            >
              Phiếu xuất
            </button>
        ...
        <div class="flex justify-between items-center">
          <div>
            <button
              class="bg-green-100 text-green-600 px-3 py-1 rounded-lg text-sm font-medium"
            >
              Phiếu nhập
            </button>
