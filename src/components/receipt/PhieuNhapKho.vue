                ...
                <div class="bg-gray-50 rounded-lg p-6 mb-6 border border-gray-200">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-3">
                            <div class="flex justify-between">
                                <span class="text-sm font-semibold text-gray-700">Mã phiếu:</span>
                                <span class="text-sm text-gray-900 font-medium">{{ phieuToView.code || 'PNK003'
                                }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-sm font-semibold text-gray-700">Nguồn nhập:</span>
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between">
                                ...
                                <span class="text-sm text-gray-900 font-medium">{{ phieuToView.quantity || '10'
                                }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-sm font-semibold text-gray-700">Giá nhập:</span>
                                <span class="text-sm text-gray-900 font-medium">{{ formatPrice(phieuToView.price) ||
                                    '15.000.000 VNĐ' }}</span>
                            </div>
                            <div class="flex justify-between">
