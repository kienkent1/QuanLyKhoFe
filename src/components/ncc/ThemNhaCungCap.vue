      ...
      <form @submit.prevent class="grid grid-cols-1 md:grid-cols-3 gap-6" enctype="multipart/form-data">
        <div class="mb-2">
          ...
          <div class="mb-2">
            ...
            <input v-model="formData.TenNCC" type="text" placeholder="Nhập tên nhà cung cấp"
          ...
          <div class="mb-2">
            ...
            <input v-model="formData.Email" type="email" placeholder="Nhập email nhà cung cấp"
              class="w-full rounded-lg border border-gray-300 bg-gray-50 px-3 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none" />
          </div>
          ...
          <div v-if="previewUrl" class="mt-3">
            ...
            <img :src="previewUrl" alt="Preview" class="h-32 w-auto rounded-lg border shadow-sm object-contain" />
          </div>
        </div>
        ...
        <div>
          <!-- phone -->
          <div class="mb-2">
            <label class="block mb-2 text-sm font-medium text-gray-700">Điện thoại
            </label>
            <input v-model="formData.DienThoai" type="tel" placeholder="Nhập số điện thoại nhà cung cấp"
              class="w-full rounded-lg border border-gray-300 bg-gray-50 px-3 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none" />
          </div>
          ...
          <div class="mb-2">
            ...
            <textarea v-model="formData.DiaChi.DiaChiNha" placeholder="Nhập địa chỉ chi tiết" rows="5"
              class="w-full rounded-lg border border-gray-300 bg-gray-50 px-3 py-2.5 text-sm resize-none focus:ring-2 focus:ring-blue-500 outline-none"></textarea>
          </div>
        </div>
        ...
        <div>
          <!-- địa chỉ -->
          <div class="mb-2">
            <label class="block mb-2 text-sm font-medium text-gray-700">Tỉnh</label>
            <input v-model="formData.DiaChi.Tinh" type="text" placeholder="Nhập địa chỉ nhà cung cấp"
              class="w-full rounded-lg border border-gray-300 bg-gray-50 px-3 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none" />
          </div>

          <div class="mb-2">
            <label class="block mb-2 text-sm font-medium text-gray-700">Phường</label>
            <input v-model="formData.DiaChi.Phuong" type="text" placeholder="Nhập địa chỉ nhà cung cấp"
              class="w-full rounded-lg border border-gray-300 bg-gray-50 px-3 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none" />
          </div>

          <div class="mb-2">
            <label class="block mb-2 text-sm font-medium text-gray-700">Quận/Huyện</label>
            <input v-model="formData.DiaChi.QuanHuyen" type="text" placeholder="Nhập địa chỉ nhà cung cấp"
              class="w-full rounded-lg border border-gray-300 bg-gray-50 px-3 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none" />
          </div>
        </div>
      </form>
