<template>
  <div class="p-6">
        ...
        <div class="relative">
          ...
          >
            <button
              ...
              @click="setSort('Nhiều → Ít')"
            >
              Nhiều → Ít
            </button>
            <button
              class="block w-full px-4 py-2 text-left hover:bg-gray-100"
              @click="setSort('Ít → Nhiều')"
            >
              Ít → Nhiều
            </button>
            <div class="border-t border-gray-200"></div>
            <button
              class="block w-full px-4 py-2 text-left hover:bg-red-50 text-red-600"
              @click="setSort('Cảnh báo số lượng')"
            >
              ⚠️ Cảnh báo số lượng
            </button>
          </div>
    ...
    <!-- BẢNG -->
    <div
      class="bg-white border border-gray-200 rounded-xl overflow-visible shadow-sm"
    >
      <table class="w-full text-sm border-collapse">
        <thead class="bg-gray-200 text-gray-800">
          <tr>
            ...
            <th
              class="border border-gray-300 p-3 font-semibold text-center pr-6"
            >
              Số lượng
            </th>
            <th class="border border-gray-300 p-3 text-center">
      ...
      <!-- PHÂN TRANG -->
      <div
        class="flex items-center justify-between p-4 text-sm text-gray-600 border-t border-gray-100"
      >
        <p>
      ...
      >
        <div
          class="bg-white rounded-2xl shadow-2xl w-[750px] max-w-[90%] p-8 relative animate-fadeIn"
        >
          <!-- Nút đóng -->
          <button
          ...
          <!-- Tiêu đề -->
          <h2 class="text-2xl font-bold text-gray-900 text-left mb-6">
            Thêm hàng hóa
          </h2>

          <!-- Form content với background xám -->
          <div
            class="grid grid-cols-2 gap-4 bg-gray-50 p-6 rounded-xl shadow-inner"
          >
            <!-- Tên hàng hóa -->
            ...
            <div>
              ...
              <p v-if="errors.nhaCC" class="text-red-500 text-xs mt-1">
                {{ errors.nhaCC }}
              </p>
            </div>
            ...
            <div>
              ...
              <p v-if="errors.loai" class="text-red-500 text-xs mt-1">
                {{ errors.loai }}
              </p>
            </div>
            ...
            <div class="col-span-2">
              ...
              />
              <p v-if="errors.soLuong" class="text-red-500 text-xs mt-1">
                {{ errors.soLuong }}
              </p>
            </div>
          </div>
      ...
      >
        <div
          class="bg-white rounded-2xl shadow-2xl w-[800px] p-6 relative animate-fadeIn"
        >
          <!-- Nút đóng -->
          <button
      ...
      >
        <div
          class="bg-white rounded-2xl p-8 w-[600px] max-w-[90%] relative shadow-2xl"
        >
          <button
          ...
          <!-- HEADER -->
          <div
            class="flex justify-between items-center border-b border-gray-100 pb-4 mb-6"
          >
          ...
          <div
            v-if="hasBasicConfig"
            class="bg-gray-100 rounded-lg p-6 mb-6 border border-gray-200"
          >
            <h4
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div v-if="selectedItem.moTa" class="md:col-span-2">
                <div class="flex flex-col gap-1">
                  ...
                  >
                  <span
                    class="text-sm text-gray-900 bg-white p-3 rounded-lg border"
                    >{{ selectedItem.moTa }}</span
                  >
                </div>
              </div>
            </div>
          ...
          >
            ...
            >
              ...
              >
                <path
                  ...
                  stroke-linejoin="round"
                  stroke-width="2"
                  d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4m6 6v2m6-2a2 2 0 100 4m0-4a2 2 0 100 4m0-4v2m0-6V4"
                />
              </svg>
              Cấu hình tùy chỉnh
            </h4>
            ...
            <div class="space-y-3">
              <div
                v-for="config in selectedItem.config"
                :key="config.id"
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-600">
                      {{ config.value }}
                      <span class="text-gray-400">({{ config.type }})</span>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div
            v-if="!hasBasicConfig && !hasCustomConfig"
            class="bg-gray-50 rounded-lg p-6 mb-6 border border-gray-200 text-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <div
          class="bg-white rounded-2xl shadow-2xl w-[750px] max-w-[90%] p-8 relative"
        >
          <button
          ...
          >
            ...
            <div class="col-span-2">
              ...
              />
              <p v-if="editErrors.ten" class="text-red-500 text-xs mt-1">
                {{ editErrors.ten }}
              </p>
            </div>
            ...
            <div>
              ...
              <p v-if="editErrors.nhaCC" class="text-red-500 text-xs mt-1">
                {{ editErrors.nhaCC }}
              </p>
            </div>
            ...
            <div>
              ...
              <p v-if="editErrors.loai" class="text-red-500 text-xs mt-1">
                {{ editErrors.loai }}
              </p>
            </div>
            ...
            <div class="col-span-2">
              ...
              />
              <p v-if="editErrors.soLuong" class="text-red-500 text-xs mt-1">
                {{ editErrors.soLuong }}
              </p>
            </div>
          </div>
      ...
      >
        <div
          class="bg-white rounded-2xl p-8 w-[400px] max-w-[90%] relative shadow-2xl"
        >
          <button
          ...
          >
            <div class="flex items-center gap-2">
              ...
              <span class="text-sm font-medium text-yellow-800"
                >Bạn có chắc chắn muốn xóa hàng hóa này?</span
              >
            </div>
      ...
      >
        <div
          class="bg-white rounded-2xl shadow-2xl w-[800px] max-w-[90%] max-h-[90vh] overflow-y-auto relative"
        >
          <button
            ...
            <div class="bg-gray-100 rounded-lg p-4 mb-6 border border-gray-200">
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-600">
                    Mã: {{ selectedItem.ma }} | Loại: {{ selectedItem.loai }}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-lg p-6 mb-6 border border-gray-200">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                  <input
                    v-model="configForm.tenPhienBan"
                    type="text"
                    placeholder="VD: Pro, Max, Ultra..."
                    class="w-full bg-white text-gray-800 placeholder-gray-400 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 transition border border-gray-200"
                  />
                </div>
                ...
                <div class="md:col-span-2">
                  ...
                  >
                  <textarea
                    v-model="configForm.moTa"
                    rows="3"
                    placeholder="Nhập mô tả chi tiết..."
                    class="w-full bg-white text-gray-800 placeholder-gray-400 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 transition border border-gray-200 resize-none"
                  ></textarea>
                </div>
              </div>
            </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                  ...
                  <input
                    ...
                    type="text"
                    placeholder="VD: Kích thước, Công suất..."
                    class="w-full bg-white text-gray-800 placeholder-gray-400 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 transition border border-gray-200"
                  />
                </div>
...
import Loader from "../../components/helper-components/Loader.vue";
...
function onRowSelectionChange() {
  ...
  const allSelected =
    ...
    filteredData.value.every((i) => i.selected);
  ...
  (newVal) => {
    if (startIndex.value >= newVal.length && currentPage.value > 1) {
      currentPage.value = Math.max(
        1,
        Math.ceil(newVal.length / pageSize.value)
      );
    }
